...
echo "$($PSQL "SELECT name FROM teams FULL JOIN games ON teams.team_id = games.winner_id or teams.team_id = games.opponent_id WHERE year=2014 and round='Eighth-Final' and (opponent_id=team_id or winner_id=team_id) ORDER BY name")"
